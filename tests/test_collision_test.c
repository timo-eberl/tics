...
static void epa_cycling_test_1(void) {
	...
	tics_transform cube_t = {.position = {-4.71135092f, 0.13406682f, -3.19023204f},
							 .rotation = {0.286603302f, 0.118719958f, 0.878672123f, 0.363123149f}};

	tics_transform sphere_t = {
		.position = {-3.22701406f, 0.377987236f, -3.94106793f},
...
static void gjk_cycling_test_1(void) {
	...
	tics_transform cube_t = {.position = {-0.367497623, 0.279514551, 3.76133966},
							 .rotation = {-0.294131428, -0.124484502, -0.24287124, -0.915972233}};

	tics_transform sphere_t = {.position = {-2.0598464, 0.83966881, 3.97224188},
